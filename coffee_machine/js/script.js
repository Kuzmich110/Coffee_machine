 let money = document.getElementById("money");
        ...
        let coffe_mag = document.getElementById("coffe_mag");
        ...
        for (let i=0; i<bills.length; i++){
          ...
          coffe_mag.onclick = function(){
            if (this.style.opacity!=0){
              this.style.opacity = 0;
              let audio = new Audio("../audio/02628.mp3");
              audio.play();
            }
          }
          

        function getCoffee(coffeName,cost){
          if (money.value>= cost){
